...
##
##   nim c -r -d:release test/bench_vm.nim --json > /tmp/before.json
##   # ...change the VM...
##   nim c -r -d:release test/bench_vm.nim --json > /tmp/after.json
##   nim c -r test/bench_compare.nim /tmp/before.json /tmp/after.json
##
